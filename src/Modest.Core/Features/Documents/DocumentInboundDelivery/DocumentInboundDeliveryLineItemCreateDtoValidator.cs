...
public class DocumentInboundDeliveryLineItemCreateDtoValidator
    : AbstractValidator<DocumentInboundDeliveryLineItemCreateDto>
{
    public DocumentInboundDeliveryLineItemCreateDtoValidator()
    {
        RuleFor(x => x.Product)
            .NotNull()
